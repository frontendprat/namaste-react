  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          src="https://template.canva.com/EAGXsRURT9o/1/0/1600w-JrzZUwc_CLQ.jpg"
          height="150"
          width="150"
        />
      </div>
  ...
  return (
    <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
      ...
      <img
        ...
        alt="res-logo"
        src={
          "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2025/12/13/" +
          cloudinaryImageId
        }
      />
      <h3>{name}</h3>
